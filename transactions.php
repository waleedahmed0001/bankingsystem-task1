...
echo '<center>';
echo '<table class="col-s-12 col-6 col-m-12 "> <th>SENDER   </th>   <th> RECIEVER   </th> <th> AMOUNT   </th>   <th> DATE </th> ';
    while($row = $result->fetch_assoc()) {
        echo "<tr> <td> ". $row["sender_email"]. " </td>  <td>". $row["reciever_email"]. " </td>  <td> " . $row["amount"] . "</td> <td> 
        ".$row["date"] .  "' </td><tr>";
    }
