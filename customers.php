...
<head>
  ...
  <link rel="stylesheet" href="css/customers_css.css">
...
echo  '<br> <h1 style="text-align:center;"> ALL CUSTOMERS ('.$result->num_rows.')</h1> <br>';

if ($result->num_rows > 0) {
    // output data of each row
 echo '<div class="col-3">
 </div>';
echo '<table class="col-s-12 col-12 col-m-12 "> <th>NAME   </th>   <th> EMAIL   </th> <th> BALANCE   </th> ';
    while($row = $result->fetch_assoc()) {
        echo "<tr> <td> ". $row["name"]. " </td>  <td>". $row["email"]. " </td>  <td> " . $row["balance"] . "</td> <td> <button
        > <a href='transfer.php?id=".$row["id"] .  "'> Transfer Money </a> </button> </td><tr>";
    }
